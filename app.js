...
app.get("/propietarios/:rfc",prop.buscarpropietario)
app.get("/propietarios/borrar/:rfc",prop.borrarpropietario)
...
app.use('/routerPropietarios', propietariosRouter);
app.use('/routerArrendatarios', arrendatariosRouter);
app.use('/routerPropiedades', propiedadesRouter);
